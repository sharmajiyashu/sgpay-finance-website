    ...
    <>
      ...
      <div className="container-fluid page-header mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div className="container text-center text-dark py-5">
          <h1 className="display-4 mb-3">Our Finance Services</h1>
          <nav aria-label="breadcrumb">
            <ol className="breadcrumb justify-content-center mb-0">
              <li className="breadcrumb-item"><Link className="text-dark" href="/">Home</Link></li>
              <li className="breadcrumb-item active text-primary" aria-current="page">Finance</li>
            </ol>
          </nav>
        </div>
      </div>
      ...
      <div className="container-xxl py-5">
        <div className="container">
          <div className="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style={{ maxWidth: "700px" }}>
            <p className="d-inline-block border rounded text-primary fw-semi-bold py-1 px-3">Wealth & Growth</p>
            <h1 className="display-5 mb-3">Customized Financial Solutions For You</h1>
            <p className="text-muted">Explore investment options, secure insurance plans, and professional portfolios structured to grow your capital.</p>
          </div>
          <div className="row g-4">
            {FINANCE_SERVICES.map((service, idx) => (
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay={`${0.1 * (idx % 3 + 1)}s`} key={service.slug}>
                <div className="card h-100 border rounded shadow-sm hover-shadow p-4 bg-white d-flex flex-column justify-content-between">
                  <div>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <h4 className="mb-0 text-dark">{service.title}</h4>
                    </div>
                    <p className="text-muted mb-3" style={{ fontSize: "14px", height: "60px", overflow: "hidden" }}>{service.overview}</p>
                    <div className="mb-4">
                  ...
                  <div>
                    <Link href={`/finance/${service.slug}`} className="btn btn-primary w-100 rounded-pill mt-3 py-2 fw-bold">
